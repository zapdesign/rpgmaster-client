...
export default function MenuPrincipal({
    ...
    return (
        <section style={{display: 'flex', height: '100vh'}}>
            ...
            <Link href={`/app/${project[0].id}/dice`} style={{marginTop: '15px', fontSize: '12px', display: 'flex', gap: '10px',padding: '12px 10px', backgroundColor: isActive(`/app/[projectId]/dice`) ? "#12131D" : "none", border: isActive(`/app/[projectId]/dice`) ? "solid 1px #292943" : "none", borderRadius: '10px'}}><FaDiceD20 /> Dados</Link>
